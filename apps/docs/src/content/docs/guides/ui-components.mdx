...
when consent is already valid or skipped (bot detected).
...
After consent is given, a floating **Cookie Settings** button appears at the bottom-left corner so
users can re-open the panel and withdraw or change their consent at any time.
