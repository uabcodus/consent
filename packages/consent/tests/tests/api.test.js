...
describe("API tests", () => {
  ...
  it("Should erase cookie with specific path and domain", () => {
    document.cookie =
      "test_cookie5=21; expires=Sun, 1 Jan 2063 00:00:00 UTC; path=/; domain=" + location.host;
  ...
  it("Should not erase cookie with wrong path", () => {
    document.cookie =
      "test_cookie6=28; expires=Mon, 1 Jan 2064 00:00:00 UTC; path=/; domain=" + location.host;
  ...
  it("Should not erase cookie with wrong domain", () => {
    document.cookie =
      "test_cookie7=35; expires=Wed, 1 Jan 2065 00:00:00 UTC; path=/; domain=" + location.host;
  ...
  it("Should accept all services", () => {
    ...
    const numDefinedServices = Object.keys(
      api.getConfig("categories")["analytics"].services,
    ).length;
