...
declare namespace CookieConsent {
  ...
  interface UserPreferences {
    ...
    acceptedServices: { [key: string]: Array<string> };
    rejectedServices: { [key: string]: Array<string> };
  }
  ...
  interface CookieValue {
     ...
     */
    services: { [key: string]: Array<string> };
  ...
  interface CookieConsentConfig {
    ...
    onChange?: (param: {
      ...
      changedServices: { [key: string]: Array<string> };
    }) => void;
     ...
     */
    onModalReady?: (param: { modalName: ModalName; modal: HTMLElement }) => void;
   ...
   */
  function acceptService(services: string | Array<string>, category: string): void;
