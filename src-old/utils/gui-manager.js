...
const alignV = [CLASS_CONSTANTS._middle, CLASS_CONSTANTS._top, CLASS_CONSTANTS._bottom];

const alignH = [CLASS_CONSTANTS._left, CLASS_CONSTANTS._center, CLASS_CONSTANTS._right];
...
const setLayout = (
  ...
  const currentLayoutName = layoutName in allowedLayoutsObj ? layoutName : defaultLayoutName;
  ...
  const positionH =
    modalClassPrefix === CLASS_CONSTANTS._pmPrefix ? positionSplit[0] : positionSplit[1];
